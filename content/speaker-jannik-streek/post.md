---
title: "Speaker Spotlight: Jannik Streek – Beyond the Vibes: Lessons from Using Spec Driven Development Frameworks for Agentic Coding"
description: "Jannik Streek compares Spec Driven Development frameworks for agentic coding and shares practical lessons on when writing specs actually pays off."
...
We're excited to announce **Jannik Streek** as a speaker at [Agentic Conf Hamburg](https://lu.ma/45lfeyeh) on March 22nd!
...
Spec Driven Development (SDD) promises a better approach to agentic programming in larger software projects by focusing on the _what_, not the _how_: defining requirements from which implementation can be derived. Instead of going prompt by prompt and nudging code changes, specifications clearly separate requirements from implementation and let you think in capabilities.
