...
pubDatetime: 2026-03-20T09:25:00+01:00
title: "Speaker Spotlight: Aleksandr Lossenko – How a 3-Day Hackathon Gave Non-Engineers Access to the Codebase at Remote.com"
featured: false
draft: false
description: "Aleksandr Lossenko shares how Remote.com built Sherlock App in a 3-day hackathon – a Phoenix LiveView tool that lets anyone query the codebase in plain English using OpenCode and MCP."
tags:
  - conference
  - speaker
  - agentic-conf
...
<Image
  src={bannerImg}
  alt="Speaker Spotlight: Aleksandr Lossenko – How a 3-Day Hackathon Gave Non-Engineers Access to the Codebase at Remote.com"
  widths={[400, 800, 1200]}
  sizes="(max-width: 800px) 100vw, 800px"
/>

We're excited to announce **Aleksandr Lossenko** as a speaker at [Agentic Conf Hamburg](https://agentic.hamburg) on March 22nd!
