...
pubDatetime: 2026-03-21T09:15:00+01:00
title: "Speaker Spotlight: Leo Peters – Stop Building Features. Build the Factory That Builds Them."
featured: false
draft: false
description: "Leo Peters opens a real factory from a real client project and walks through how to go from AI-assisted to genuinely autonomous software delivery."
tags:
  - conference
  - speaker
  - agentic-conf
...
<Image
  src={bannerImg}
  alt="Speaker Spotlight: Leo Peters – Stop Building Features. Build the Factory That Builds Them."
  widths={[400, 800, 1200]}
  sizes="(max-width: 800px) 100vw, 800px"
/>

We're excited to announce **Leo Peters** as a co-speaker (with Benedikt Stemmildt) at [Agentic Conf Hamburg](https://agentic.hamburg) on March 22nd!
