...
pubDatetime: 2026-03-10T19:00:00+01:00
title: "Speaker Spotlight: Luis Bezzenberger – A Tiny Intelligent Being Lives Inside a Box Under My Desk"
featured: false
draft: false
description: "Luis Bezzenberger shows what happens when you run a local AI agent that manages your CRM, email, and calendar – with privacy as an enabler, not a constraint."
tags:
  - conference
  - speaker
  - agentic-conf
...
<Image
  src={bannerImg}
  alt="Speaker Spotlight: Luis Bezzenberger – A Tiny Intelligent Being Lives Inside a Box Under My Desk"
  widths={[400, 800, 1200]}
  sizes="(max-width: 800px) 100vw, 800px"
/>

We're excited to announce **Luis Bezzenberger** as a speaker at [Agentic Conf Hamburg](https://lu.ma/45lfeyeh) on March 22nd!
